...
public class GreeterImpl extends GreeterGrpc.GreeterImplBase {
   ...
   * */
  @Override
  public void sayHello(GRPC.CommunicationRequest request, StreamObserver<GRPC.CommunicationReply> responseObserver) {
     ...
     */
    GRPC.CommunicationReply reply = GRPC.CommunicationReply.newBuilder().setMessage("Hello " + request.getName()).build();
