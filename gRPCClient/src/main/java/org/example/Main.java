...
public class Main {
  public static void main(String[] args) {
     ...
     * Below we call the function sayHello(GRPC.CommunicationRequest request) with name field value set to "gRPC".
     * This function returns a value of type  GRPC.CommunicationReply that is saved in our instance reply.
     * We can get via generated functions every field from our message, in this example, we have just one field.
     * */
    GRPC.CommunicationReply reply = bookStub.sayHello(GRPC.CommunicationRequest.newBuilder().setName("gRPC").build());
